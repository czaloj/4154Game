...
class MenuScreen extends IGameScreen {
    ...
    override public function onEntry(gameTime:GameTime):Void {
        ...
        var tf1:TextField = new TextField(160, 50, "Level 1", "Font", 32);
        ...
        var tf2:TextField = new TextField(150, 50, "Level 2", "Font", 32);
    ...
    public function changeButtonState(button:Int, state:Int):Void
    {
        if (button == 1) {
            ...
            var tf:TextField = new TextField(150, 50, "Level 1", "Font", 20);
            button1.addChild(tf);
            screenController.addChild(button1);
        }
            ...
            var tf:TextField = new TextField(150, 50, "Level 2", "Font", 20);
            button2.addChild(tf);
            screenController.addChild(button2);
        }
    }
