...
class RectangleUtil
{
    ...
    private static var _sPositions:Array<Point>;
    private static var sPositions(get, null):Array<Point>;
    ...
    static function get_sPositions():Array<Point>
    {
        if (_sPositions == null) {
            _sPositions = new Array<Point>();
            _sPositions.push(new Point(0, 0));
            _sPositions.push(new Point(1, 0));
            _sPositions.push(new Point(0, 1));
            _sPositions.push(new Point(1, 1));
        }
        return _sPositions;
    }
}