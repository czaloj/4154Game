...
{
    /** Helper objects. */
    private static var _sRawData:Vector<Float>;
    private static var sRawData(get, null):Vector<Float>;
    private static var sRawData2 = new Vector<Float>(16, true);
    ...
    private static function get_sRawData():Vector<Float> 
    {
        if (_sRawData == null) {
            _sRawData = new Vector<Float>();
            _sRawData.push(1.0);
            _sRawData.push(0.0);
            _sRawData.push(0.0);
            _sRawData.push(0.0);
