...
class GameLevel {
    ...
    public var parallax: Array<graphics.SpriteSheet>;//List of parallax image files, in the order of drawing
    public var environmentSprites:graphics.SpriteSheet;//Sprite sheet identifier for the environment
    public var enemiesSprites:graphics.SpriteSheet;//Sprite sheet identifier for the enemies
